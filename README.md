...
| Increment an Arbitrary-Precision Integer | [:heavy_check_mark:](https://github.com/anthonygraca/epi/blob/main/src/main/data-structures-and-algorithms/arrays/arbitrary-precision-integer.h) | [:heavy_check_mark:](https://github.com/anthonygraca/epi/blob/main/src/test/data-structures-and-algorithms/arrays/arbitrary-precision-integer.cc) | O(n) | O(1) |
